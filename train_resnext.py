...
def parse_args():
    ...
    parser.add_argument('--datapath', type=str, default='data/dataset_age_UTK', help='root path of dataset')
    parser.add_argument('--test_datapath', type=str, default='data/dataset_age_UTK', help='root path of test dataset')
