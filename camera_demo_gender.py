...
def main(args):
    # Model
    resnext = se_resnext50(num_classes=2).to(device)
    resnext.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained',type=str,default='saved models/resnext_82_dataset_gender_64_0.01_40_1e-06.pth.tar'
                        ,help='load weights')
